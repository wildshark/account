 ...
 */
 ...
 if (empty($_GET['staff'])) {
     ...
     function loan_sheet($conn){

         $sql = "SELECT *FROM get_staff_loan";
         $loan = $conn->query($sql);
     ...
     function loan_sheet($conn,$staffID){

         $sql = "SELECT *FROM get_staff_loan WHERE staffID='$staffID'";
         $loan = $conn->query($sql);
         while ($l = $loan->fetch_assoc()) {
             echo "
                <tr class='gradeX'>
            ...
            <div class="widget-content nopadding">
                <form class="form-horizontal">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="account.php?user=staff.loan&error=0&alert=1"  class="btn btn-success">New</a>
                    </div>
                </form>
            </div>
        </div>
